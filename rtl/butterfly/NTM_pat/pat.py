...
one = 1
R2 = 10952
with open("ntm_ai.dat", "w") as int_ai, \
     open("ntm_bi.dat", "w") as int_bi, \
     open("ntm_gm.dat", "w") as int_gm, \
     open("ntm_ao.dat", "w") as int_ao, \
     open("ntm_bo.dat", "w") as int_bo, \
     open("ntm_ai_check.dat", "w") as int_ai_check, \
     open("ntm_bi_check.dat", "w") as int_bi_check, \
     open("ntm_gm_check.dat", "w") as int_gm_check, \
     open("ntm_ao_check.dat", "w") as int_ao_check, \
     open("ntm_bo_check.dat", "w") as int_bo_check:
