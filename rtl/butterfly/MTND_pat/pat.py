...
one = 1
R2 = 10952
with open("mtnd_ai.dat", "w") as int_ai, \
     open("mtnd_bi.dat", "w") as int_bi, \
     open("mtnd_gm.dat", "w") as int_gm, \
     open("mtnd_ao.dat", "w") as int_ao, \
     open("mtnd_bo.dat", "w") as int_bo, \
     open("mtnd_ai_check.dat", "w") as int_ai_check, \
     open("mtnd_bi_check.dat", "w") as int_bi_check, \
     open("mtnd_gm_check.dat", "w") as int_gm_check, \
     open("mtnd_ao_check.dat", "w") as int_ao_check, \
     open("mtnd_bo_check.dat", "w") as int_bo_check:
