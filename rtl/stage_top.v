...
// parameter for destination
  ...
  always @ (posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (ss_rdy && ss_vld && meta_counter == 12'h0 && destination == 8'b00010100) begin
        coef_fft_done <= 1;
      end else if (ss_rdy && ss_vld && meta_counter != 12'h0 && destination == 8'b00010100) begin
        coef_fft_done <= 0;
      end else begin
        coef_fft_done <= coef_fft_done;
      end
    end
  end
...
assign k4_coef_en5 = (isempty && push || pop) && fetching_kernal_next == 5'd20 || (coef_vld_mux == 5'd20);
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k2_sw_lst) begin
        step_cnt5_k2 <= 5'h1F;
      end else if (step_cnt5_k2 == 5'h1F && k2_bpe5_en) begin
        step_cnt5_k2 <= 5'h0;
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k2_sw_lst) begin
        stage9_cnt_k2 <= 12'h0;
      end else if (step_cnt5_k2 != 5'h1F) begin
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k3_sw_lst) begin
        step_cnt5_k3 <= 5'h1F;
      end else if (step_cnt5_k3 == 5'h1F && k3_bpe5_en) begin
        step_cnt5_k3 <= 5'h0;
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k3_sw_lst) begin
        stage9_cnt_k3 <= 12'h0;
      end else if (step_cnt5_k3 != 5'h1F) begin
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k4_sw_lst) begin
        step_cnt5_k4 <= 5'h1F;
      end else if (step_cnt5_k4 == 5'h1F && k4_bpe5_en) begin
        step_cnt5_k4 <= 5'h0;
  ...
  always @(posedge clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (k4_sw_lst) begin
        stage9_cnt_k4 <= 12'h0;
      end else if (step_cnt5_k4 != 5'h1F) begin
