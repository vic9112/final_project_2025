...
assign gm_mul2 = (mode[1] == 1'b1)? gm_inv:gm;//NTT use gm(unsign)
...
assign ao = (mode == 1'b1)? cmul_result[0] : mont_add_result;
assign bo = (mode == 1'b1)? cmul_result[1] : mont_sub_result;
